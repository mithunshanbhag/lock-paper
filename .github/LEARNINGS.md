...
- `src/LockPaper.Ui\Pages\MainPage.xaml` now mirrors the disconnected/connected mockups with separate portrait screen shells, stacked status cards in the connected state, and compact inline feedback instead of a notice card.
